  ...
  <div class="flex min-h-screen">
   ...
   <aside class="flex flex-col bg-gradient-to-b from-[#0057B8] to-[#8FC9F0] w-64 p-6 text-white">
    <div class="flex items-center mb-8">
     <img alt="White maintenance icon with house and wrench" class="w-10 h-10 mr-3" height="40" src="logo.png" width="40"/>
    ...
    <section class="flex-1 p-10">
     ...
     <div class="overflow-x-auto">
      <table class="w-full border-collapse border border-[#0057B8] text-center">
       ...
       <tbody>
        <tr class="h-12">
         <td class="border border-[#0057B8] bg-white"></td>
         <td class="border border-[#0057B8] bg-white"></td>
         <td class="border border-[#0057B8] bg-white"></td>
         <td class="border border-[#0057B8] text-left px-4 bg-white"></td>
         <td class="border border-[#0057B8] text-center bg-white"></td>
         <td class="border border-[#0057B8] bg-white">
          <div class="flex justify-center items-center gap-2 text-[#0057B8] text-lg">
           ...
           <i class="fas fa-check-square cursor-pointer"></i>
          </div>
         </td>
        </tr>
        <tr class="h-12">
