                ...
                <form method="POST" class="space-y-4">
                    ...
                    <div class="relative">
                        ...
                        <input 
                            ...
                            required
                            class="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-blue focus:border-transparent outline-none transition-all duration-200 bg-gray-50 focus:bg-white"
                        >
                    </div>
...
<div class="flex-1 p-8 md:p-12 text-white relative overflow-hidden rounded-r-2xl"
     style="background-image: url('image.png'); background-size: cover; background-position: center;">
